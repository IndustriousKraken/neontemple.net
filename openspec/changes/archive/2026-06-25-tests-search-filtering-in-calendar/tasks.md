...
- [x] 1.1 `searchFilteredEvents_returns_all_events_for_empty_or_whitespace_search`
...
- [x] 1.2 `searchFilteredEvents_matches_title_case_insensitively` — with an event
...
- [x] 1.3 `searchFilteredEvents_matches_description_location_and_type` — with
...
- [x] 1.4 `searchFilteredEvents_returns_empty_for_no_match` — assert that a term
  matching none of the searchable fields returns an empty array.
- [x] 1.5 `searchFilteredEvents_tolerates_events_missing_optional_fields` —

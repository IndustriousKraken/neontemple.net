...
- [x] 1.1 In `themes/terminal/assets/js/calendar.js`, change `formatDateKey`
...
- [x] 2.1 In `loadEvents` (`calendar.js:110`), after fetching events, filter out
...
- [x] 2.2 Verify the `calendarDays` getter (line 63) and `selectedDateEvents`
...
- [x] 3.1 Add a test `calendar_renders_when_an_event_has_invalid_start_time`

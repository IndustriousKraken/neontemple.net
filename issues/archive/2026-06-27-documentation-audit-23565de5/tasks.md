...
- [x] 1.1 Create `README.md` at the repo root. Open with a one-line description
...
- [x] 1.2 **Build & run** section. Document the prerequisites (Hugo, plus
...
- [x] 1.3 **Configuration** section. Document every operator-settable
...
- [x] 1.4 **Further reading** section. Cross-link the existing top-level docs so
...
- [x] 1.5 Keep the README accurate to the current repo: verify param names and

...
- [x] 1.1 In `themes/terminal/assets/js/main.test.js`, add a loader that runs
...
- [x] 1.2 `featured_banner_drops_image_url_with_css_breakout` — set the featured
...
- [x] 1.3 `featured_banner_renders_well_formed_image_url` — set `image_url` to

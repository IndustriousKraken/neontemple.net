  ...
  async fetch(endpoint, options = {}) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        // Coterie's error body is { "error": "..." }; `message` kept
        // first for any endpoint that uses it. Without this fallback a
        // duplicate-signup 409 showed as an unhelpful "HTTP 409".
